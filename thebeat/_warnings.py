...
framerounding_soundseq = UserWarning(
...
framerounding_melody = UserWarning(
    "thebeat: For one or more of the used sounds, the exact start or end positions in frames (i.e. "
...
framerounding_soundsynthesis = UserWarning("thebeat: During sound synthesis, the number of frames was rounded off."
...
missing_values = UserWarning("thebeat: There were missing values in the passed data.\n")

normalization = UserWarning(
    "thebeat: Sound was normalized to avoid distortion. If undesirable, change the amplitude of the "
    "sounds.")

phases_t_at_zero = UserWarning("thebeat: The first onset of the test sequence was at t=0.\nThis would result in a phase "
