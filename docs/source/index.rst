...
*thebeat* is an open-source, on-going, and collaborative project, integrating easily with the existing Python ecosystem, and with your own scripts.
...
If you have but are just getting started, take a look at the :ref:`Getting started` page.

Examples of how to use *thebeat* can be found both under :ref:`Examples`, but also under :ref:`Package contents`, 
